...
def parse_args():
    parser = argparse.ArgumentParser(description="Go VKDE")
    parser.add_argument('--dataset', type=str,default='yelp2018',
                        help="available datasets: [yelp2018, amazon-book, video-games]")

    parser.add_argument('--bpr_batch', type=int,default=128,
                        help="the batch size for bpr loss training procedure")
    parser.add_argument('--recdim', type=int,default=64,
                        help="the embedding size of VKDE")
    parser.add_argument('--layer', type=int,default=3,
                        help="the layer num of VKDE")
    ...
    parser.add_argument('--testbatch', type=int,default=128, # 4080跑128的yelp2018刚好溢出，5s-2min一个batch不够稳定
    ...
    parser.add_argument('--comment', type=str,default="VKDE")
